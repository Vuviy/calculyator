...
<!---->
<?php //if ($result !== null): ?>
<!--    <p><strong>Результат:</strong> --><?php //= htmlspecialchars($result) ?><!--</p>-->
<?php //elseif ($error !== null): ?>
<!--    <p style="color: red;"><strong>Помилка:</strong> --><?php //= htmlspecialchars($error) ?><!--</p>-->
<?php //endif; ?>
<!---->
<!---->
<!---->
...
<!--            <li>-->
<!--                --><?php //= htmlspecialchars($item['first']) ?>
<!--                --><?php //= htmlspecialchars($item['operator']) ?>
<!--                --><?php //= htmlspecialchars($item['second']) ?><!-- =-->
<!--                --><?php //= htmlspecialchars($item['result']) ?>
<!--                (--><?php //= htmlspecialchars($item['time']) ?><!--)-->
<!--            </li>-->
<!--        --><?php //endforeach; ?>
<!--    </ul>-->
<?php //endif; ?>
